...
import Catalogo_CangrejoWeb.CatalogoCangrejoWeb.repositorio.SupplementRepository;
...
public class SupplementService {
      @Autowired
    private SupplementRepository clotheRepository;
    ...
    public Supplement create(Supplement accesory) {
    ...
    public Supplement update(Supplement accesory) {

        if (accesory.getReference() != null) {
            Optional<Supplement> accesoryDb = clotheRepository.getClothe(accesory.getReference());
